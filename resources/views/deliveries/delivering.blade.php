        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form action="{{ route('deliveries.delivering') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ongoing Orders</h6>
                        </div>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" role="grid"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="display: flex; justify-content: center;">
                                        <form action="{{ route('deliveries.done',$delivery->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                        ...
                        {!! $deliveries->appends(['search' => Request::get('search')])->links() !!}
                    </div>
                </div>
